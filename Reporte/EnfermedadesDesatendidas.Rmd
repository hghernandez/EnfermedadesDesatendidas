...
En el período de estudio (2004-2018), se registraron `r scales::comma(tasas_esp$casos[tasas_esp$sexo== '3.Ambos sexos' & tasas_esp$edadquinq == '18.Total'],big.mark = ".",decimal.mark = ",")`defunciones por Enfermedades Desatendidas, de las cuáles `r round(tasas_esp$casos[tasas_esp$sexo== '1.Varones' & tasas_esp$edadquinq == '18.Total']*100/tasas_esp$casos[tasas_esp$sexo== '3.Ambos sexos' & tasas_esp$edadquinq == '18.Total'])`% (`r scales::comma(tasas_esp$casos[tasas_esp$sexo== '1.Varones' & tasas_esp$edadquinq == '18.Total'],big.mark = ".",decimal.mark = ",")`) se dieron en varones y `r round(tasas_esp$casos[tasas_esp$sexo== '2.Mujeres' & tasas_esp$edadquinq == '18.Total']*100/tasas_esp$casos[tasas_esp$sexo== '3.Ambos sexos' & tasas_esp$edadquinq == '18.Total'])`% (`r scales::comma(tasas_esp$casos[tasas_esp$sexo== '2.Mujeres' & tasas_esp$edadquinq == '18.Total'],big.mark = ".",decimal.mark = ",")`) en mujeres.
